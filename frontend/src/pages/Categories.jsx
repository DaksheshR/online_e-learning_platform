    ...
    <div className="panel-grid">
      <FormCard title={editingId ? 'Edit Category' : 'New Category'}>
        <form onSubmit={handleSubmit} id="category-form">
          ...
          <div className="form-actions">
            <button type="submit" className="btn btn-primary" id="category-submit">
              {editingId ? 'Update' : 'Save'} Category
            </button>
            <button type="button" className="btn btn-secondary" onClick={resetForm} id="category-reset">
              Reset
            </button>
          </div>
        </form>
      ...
      <div className="glass-card">
        ...
        <DataTable
          ...
          emptyIcon="📁"
          emptyText="No categories yet. Create one!"
        />
      </div>
    </div>
  );
